...
def plot_history_loss(history, save_dir = 0):
  ...
  plt.legend()
  if save_dir:
    plt.savefig(join(save_dir,"history_loss.jpg"))    
  plt.show()
...
#training the model
save_model_weights_path = splitext(join(save_dir))[0] +'_weights.hdf5'
...
#plt.legend()
#
#plt.savefig(join(output_dir,"history.jpg"))
#plt.show()
