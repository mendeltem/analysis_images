...
#dict_in = 0
#dict_ex = 0
#sorted_score_in_values = dict_in['sorted_score_values']
#features_in            = dict_in["features"]
...
for i, mix in enumerate(mixed): 
  ...
  #dream(base_image_path, result_prefix, str(mix),  layer[i])
  if i > 1: 
    break


dream(base_image_path, result_prefix, "433", [3])
